...
//   const noserach = document.getElementById('noserach');
...
//       const index = client.initIndex('output-frontend'); // Replace with your actual index name
...
//           anchorLink.href = hit.url;
//           anchorLink.textContent = decodeHtmlEntities(hit._highlightResult.hierarchy.lvl1.value); // Decode HTML entities

//           // Append the anchor link to the card body
//           cardBody.appendChild(anchorLink);

//           // Append the card body to the card container
//           resultItem.appendChild(cardBody);

//           // Append the whole card to the search results
...
//     } else {
//       searchResults.innerHTML = ''; // Clear results when query is empty
//     }
//   });
//   })
