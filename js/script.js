      ...
      if (parentElement && parentElement.tagName === "LI") {
        ...
        if (previousSibling) {
          ...
          <a href="${preATagHref}" class="previous d-flex">
            <div class="arrowIcon me-3 d-none d-md-flex d-md-justify-content-center d-md-align-items-center">
        ...
        nextBtn.innerHTML = `
            <a href="${nextATagHref}" class="next d-flex">   
                ...
                <div class="arrowIcon ms-3 d-none d-md-flex d-md-justify-content-center d-md-align-items-center">
                  <div class="d-flex justify-content-center align-items-center">
